...
export function CourseFilters() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 justify-between items-center p-5 bg-white dark:bg-[#111] border-b border-slate-200 dark:border-slate-800 rounded-t-2xl">
